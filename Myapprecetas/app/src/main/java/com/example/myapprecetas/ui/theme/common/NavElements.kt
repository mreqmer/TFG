...
sealed class BottomNavItem(val route: String, val label: String, val icon: Int, val selectedIcon: Int) {
    object ListadoRecetas : BottomNavItem("lista_recetas", "Recetas",  R.drawable.pot2, R.drawable.pot)
    ...
    object Construccion : BottomNavItem("construccion", "Más", R.drawable.user, R.drawable.usero)
}
